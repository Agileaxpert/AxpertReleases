...
<head id="Head1" runat="server">
    ...
    <link href="../newPopups/axpertPopup.min.css?v=17" rel="stylesheet" />
    <script src="../newPopups/axpertPopup.min.js?v=38" type="text/javascript"></script>
    <%--remodel popup end--%>
    ...
    <link href="../Css/globalStyles.min.css?v=28" rel="stylesheet" />
    ...
    <script src="../Js/alerts.min.js?v=27" type="text/javascript"></script>
    <%if (templateText == String.Empty)
        {%>
    ...
    <script src="../Js/helper.min.js?v=113"></script>
    ...
    <script type="text/javascript" src="../Js/common.min.js?v=74"></script>
    <script src="../Js/process.min.js?v=180"></script>
    <script type="text/javascript" src="../Js/lang/content-<%=langType%>.js?v=41"></script>
    ...
    <script type="text/javascript" src="../js/main.min.js?v=221"></script>
</head>
