...
namespace Util
{
    ...
    public class Util
    {
        ...
        public bool IsImageAvailable(string imageName)
        {
            ...
            FileInfo fil = new FileInfo(HttpContext.Current.Server.MapPath("../Axpimages\\" + imageName));
            if (fil.Exists)
                imageExists = true;
        ...
        public bool IsValidQueryString(string url)
        {
        ...
        public void GetDBConnection(string strProj, string contents)
        {
            ...
            HttpContext.Current.Session["dbDatabaseName"] = database;
            ...
            if (mapUsername != string.Empty && mapPassword != string.Empty)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        string errorLog = logobj.CreateLog(authenticationStatus, "GridAttachmentErrors\\" + HttpContext.Current.Session.SessionID, "Attachments-Impersonator", "new", "true");
                        return false;
                    }
                }
                catch (Exception ex)
                {
                    ...
                    string errorLog = logobj.CreateLog(ex.Message, "GridAttachmentErrors\\" + HttpContext.Current.Session.SessionID, "Attachments-Impersonator", "new", "true");
                    return false;
                }
            }
            return true;
