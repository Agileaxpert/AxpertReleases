...
public class TStructDef
{
    ...
    public struct FieldStruct
    {
        ...
        public string custdatatype
        {
            get { return fldCustDatatype; }
            set { fldCustDatatype = value; }
        }
    ...
    private void XmlLoadTabDcs(XmlNode iframeNodes)
    {
        if (axdesignJObject.selectedLayout != null)
        {
            ...
            if ((tstLayout == "tile" && designMode) || isWizardTstruct) tstLayout = "default";
    ...
    private void XmlLoadField(XmlNode fieldNodes)
    {
        fieldIndex++;
        ...
        foreach (XmlNode fldNode in fieldNodes)
        {
            ...
            else if (fldNode.Name == "a69")
                fld.custdatatype = fldNode.InnerText;
    ...
    private FieldStruct LoadFieldArray(FieldStruct fld)
    {
        ...
        fieldArray.Append(" FNames[" + fldNo + "]=\"" + fld.name + "\";ExprPosArray[" + fldNo + "]=\"\";FLowerNames[" + fldNo + "]=\"" + fld.name.ToLower() + "\"; FDataType[" + fldNo + "]=\"" + fld.datatype + "\"; FCustDatatype[" + fldNo + "]=\"" + fld.custdatatype + "\"; FDecimal[" + fldNo + "]=\"" + fld.flddecimal + "\";FldValidateExpr[" + fldNo + "]=\"" + fld.vexpr.Replace("\"", "'") + "\";FDupDecimals[" + fldNo + "]=\"" + fld.flddecimal + "\";");
        ...
        if ((btnNodes.Attributes["cat"] != null) && (btnNodes.Attributes["cat"].Value == "btn"))
        {
            ...
            if (dimension != string.Empty)
            {
                ...
                if (action != "")
                {
                    ...
                    btnHtml.Append("<div id=\"dv" + btnId + "\" class=\"labelcol inputs  grid-stack-item-content form-group\">");
                ...
                else if (task != "tasks")
                {
                    ...
                    if (string.IsNullOrEmpty(image))
                        btnHtml.Append("<input type='button' value=\"" + caption + "\" class=\"hotbtn btn form-control\" title=\"" + hint + "\" " + btnFunction + ">");
                    else
    ...
    private void XmlLoadJsFormcontrol(XmlNode actionNodes)
    {
        ...
        foreach (XmlNode actionNode in actionNodes)
        {
            ...
            else
            {
                ...
                formcontrol.Append("tstActionName[" + actNo + "]= " + "\"" + act.actname + "\";actParRefresh[" + actNo + "]= " + "\"" + act.actParRefresh + "\";actSaveTask[" + actNo + "]= " + "\"" + act.actSaveTask + "\";");
                actNo++;
            }
        }
    ...
    private void XmlCreateCustomLabel(XmlNode customLabelNodes)
    {
        ...
        else if (nodeLabelExists.Value == "lbl")
        {
            ...
            if (!(string.IsNullOrEmpty(Labeltlhw)))
            {
                ...
                customLabelHtml.Append("<div id=\"dv" + customLabelNodes.Name + "\" class=\"labelcol inputs grid-stack-item-content form-group\">");
            ...
            if (fld.fldframeno == dcNo)
            {
                ...
                if (!fld.visibility)
                {
                    ...
                    else
                    {
                        ...
                        {
                            fieldHtml.Append("<div class='rowDUMMY grid-stack-item' " + gridStackData + " id=\"randomID_" + dc.frameno + randomID + "\"><span class=\"badge-grid-stack\">" + (randomID - 10) + "</span><div class=\"grid-stack-item-content ui-draggable-handle\"></div><div id=\"dv" + fld.name.Replace(" ", "") + "\" class=\"labelcol inputs form-group " + lblBsClass + " \" data-dataindex=" + lblBsIndex + ">");
                            ...
                            fieldHtml.Append("<label style=\"" + color + "\"  for=\"" + name + "\" " + (name.ToLower().Contains("axp_url_") ? "data-axp-url='true'" : "") + " >" + fld.caption + "</label >");//if the tstruct field contains axp_url_ then add an attribute 'data-axp-url' to display hyperlink instead of label
                            if (isHyper)
                                fieldHtml.Append("</a>");
                    ...
                    switch (fld.moe.ToUpper())
                    {
                        ...
                        case "ACCEPT":
                            SetCssClass(fld.freadonly, "tem", fld.datatype, fld.name, fldBsClass);

                            if ((fld.ctype.ToUpper() == "MEMO" || fld.datatype.ToLower() == "text") && fld.ctype.ToUpper() != "CHECK BOX")
                            {

                                SetCssClass(fld.freadonly, "memotem", fld.datatype, fld.name, fldBsClass);
                                if (!isGrid)
                            ...
                            {
                                SetCssClass(fld.freadonly, "checkbox", fld.datatype, fld.name, fldBsClass);
                                if (isGrid)
                            ...
                            {
                                if (isGrid)
                                    gridHiddenHtml.Append(GetImageHTML(fld, isGrid, name, i, fldTlhw, width));
                                fieldHtml.Append(GetImageHTML(fld, isGrid, name, i, fldTlhw, width));
                            }
                        ...
                        case "SELECT":
                            ...
                            {
                                SetCssClass(fld.freadonly, "multiFldChk", fld.datatype, fld.name, fldBsClass);
                            ...
                            {
                                SetCssClass(fld.freadonly, "multiFldRdg", fld.datatype, fld.name, fldBsClass);
                            ...
                            else if (fld.selectmode == string.Empty)
                            {
                                bool chkBox = false;
                                chkBox = IsGridCheckBox(moeValue);
                                SetCssClass(fld.freadonly, "combo", fld.datatype, fld.name, fldBsClass);
                                if (isGrid)
                                {
                                    if (chkBox)
                                    {
                                        SetCssClass(fld.freadonly, "gridChk", fld.datatype, fld.name, fldBsClass);
                        ...
                        case "AUTOGENERATE":
                            ...
                            SetCssClass(fld.freadonly, "auto", fld.datatype, fld.name, fldBsClass);
    ...
    private void SetCssClass(bool fReadOnly, string type, string fldDataType, string fldName, string bsClass)
    {
        ...
        if (fldName.ToLower().StartsWith("axptm_") || fldName.ToLower().StartsWith("axpdbtm_"))
        {
        ...
        else if (type == "tem")
        {
            ...
            else
            {
                ...
                else if (fldDataType.ToLower() == "numeric")
                {
                    if (IsFillGridCall)
                    {
                        fldCss = " readonly tabindex=\"-1\" class=\"labelInp tem Family  number " + bsClass + "\" ";
                        fldHdnCss = " readonly tabindex=\"-1\" class=\"labelInp tem Family  number " + bsClass + "\" ";
                    }
                    else
                    {
                        fldCss = " class=\"tem Family form-control  number " + bsClass + "\" ";
                        fldHdnCss = " class=\"tem Family form-control  number " + bsClass + "\" ";
                    }
                }
                else
                {
        ...
        else if (type == "memotem")
        {
            ...
            else
            {
                ...
                else if (fldDataType.ToLower() == "numeric")
                {
                    if (IsFillGridCall)
                    {
                        fldCss = " readonly tabindex=\"-1\" class=\"labelInp tem Family number memofam  " + bsClass + "\" ";
                        fldHdnCss = " readonly tabindex=\"-1\" class=\"labelInp tem Family number memofam  " + bsClass + "\" ";
                    }
                    else
                    {
                        fldCss = " class=\"tem Family number memofam form-control  " + bsClass + "\" ";
                        fldHdnCss = " class=\"tem Family number memofam form-control  " + bsClass + "\" ";
                    }
                }
                else
                {
        ...
        {
            string arabicSmallControl = string.Empty;
            if (HttpContext.Current.Session["language"].ToString().ToUpper() == "ARABIC")
            {
                arabicSmallControl = " input-sm ";
            }
            if (fReadOnly)
            {
                if (IsFillGridCall)
                {
                    fldCss = " readonly disabled tabindex=\"-1\" class=\"labelInp combotem flddis Family " + bsClass + arabicSmallControl + "\" ";
                    fldHdnCss = " readonly disabled tabindex=\"-1\" class=\"labelInp combotem flddis Family " + bsClass + arabicSmallControl + "\" ";
                }
                else
                {
                    fldCss = " disabled class=\"combotem flddis Family  form-control " + bsClass + arabicSmallControl + "\" ";
                    fldHdnCss = " disabled class=\"combotem flddis Family form-control" + bsClass + arabicSmallControl + "\" ";
                }
            }
            else
            {
                if (IsFillGridCall)
                {
                    fldCss = " readonly tabindex=\"-1\" class=\"labelInp combotem Family " + bsClass + arabicSmallControl + "\" ";
                    fldHdnCss = " readonly tabindex=\"-1\" class=\"labelInp combotem Family " + bsClass + arabicSmallControl + "\" ";
                }
                else
                {
                    fldCss = " class=\"combotem Family form-control  " + bsClass + arabicSmallControl + "\" ";
                    fldHdnCss = " class=\"combotem Family  form-control " + bsClass + arabicSmallControl + "\" ";
                }
            }
        }
    ...
    private string GetInputHTML(FieldStruct fld, bool isGrid, string name, int fldNo, string[] fldTlhw, string width, string NumericCss, string popImg, string popHdnImg)
    {
        ...
        if (isGrid)
        {
            ...
            if (NumericCss != "")
            {
                ...
                {
                    if ((fld.datatype.ToUpper() == "DATE/TIME") || fld.name.ToLower().StartsWith("axptm_") || fld.name.ToLower().StartsWith("axpdbtm_"))
                    {
            ...
            else if (fld.name.ToLower().StartsWith("axptm_") || fld.name.ToLower().StartsWith("axpdbtm_"))
            {
                if (IsFillGridCall)
                {
    ...
    private string GetPickListHTML(FieldStruct fld, bool isGrid, string name, int fldNo, string[] fldTlhw, string width, string popImg, string popHdnImg, Boolean gridHidden)
    {
        ...
        else
        {
            if (IsFillGridCall)
            {
                fldHdnCss = "readonly tabindex=\"-1\" class=\"labelInp  tem inputClass2 pixelwidth\"";
                fldCss = " readonly tabindex=\"-1\" class=\"labelInp  tem inputClass2 pixelwidth\"";
            }
            else
            {
    ...
    private string GetImageHTML(FieldStruct Fld, bool IsGrid, string Name, int fldNo, string[] fldTlhw, string width)
    {
        ...
        {
            strClass = "";
            imgHTML.Append("<div class=\"divReadOnly\"><div class=\"dvImgClear\"><i id=\"del-" + Name + "\" class=\"glyphicon glyphicon-remove icon-arrows-remove\"></i> </div>");

        }
        else
        {
            imgHTML.Append("<div class=\"divImgBorder\"><div class=\"dvImgClear\"><i id=\"del-" + Name + "\" class=\"glyphicon glyphicon-remove icon-arrows-remove\" onclick=\"ClearImageSrc(this);\"></i></div>");
        }
    ...
    private string GetFastAutoComHTML(FieldStruct fld, bool isGrid, string name, string fldReadOnly, string bgColor, bool isPicklist)
    {
        ...
        {
            var endPart = name.Substring(12);
            fldCss = fldCss.Replace("fldAutocomplete", "fldAutocomplete axpFilePath_" + endPart + " axpFilePathFld ");
        }
            ...
            for (int i = startIndex; i <= endIndex; i++)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            fieldHtml.Append("<div id=\"dv" + fld.name.Replace(" ", "") + "\" class=\"labelcol inputs form-group form  grid-stack-item \"   " + gridStackData + "><div class=\"grid-stack-item-content ui-draggable-handle\"></div>");
                        }
                    }
                    ...
                    switch (fldMOE)
                    {
                        ...
                        case "SELECT":
                            ...
                            {
                                SetCssClass(fld.freadonly, "multiFld", fld.datatype, fld.name, fldBsClass);
                                if (!isGrid)
                                {
                                    fieldHtml.Append(GetRadioGroupHTML(fld, isGrid, name, fldNo, fldTlhw, width, moeValue));
                                    gridHiddenHtml.Append(GetRadioGroupHTML(fld, isGrid, name, fldNo, fldTlhw, width, moeValue));
    ...
    protected string xywhGridStack(FieldStruct fld = new FieldStruct(), bool isTable = false, int GridX = 0, int GridY = 0)
    {
        ...
        Dc curDc = axdesignJObject.dcs.FirstOrDefault(elm => elm.dc_id == dcNo.ToString());
        ...
        if (!isTable)
        {
            ...
            //set min/max height
            if (fld.ctype.ToUpper() == "MEMO")
            {
                minH = 2;
            }
            else if (fld.datatype.ToLower() == "text" && fld.name.Contains("rtf_") || fld.name.Contains("rtfm_"))
            {
                minH = 5;
            }
            else if (fld.datatype.ToLower() == "image")
...
public class FieldsDesign
{
    ...
    public bool visibility { get; set; }//onlyGrid
}
[Serializable()]
