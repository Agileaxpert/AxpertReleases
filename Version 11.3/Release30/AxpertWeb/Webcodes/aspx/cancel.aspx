...
<head id="Head1" runat="server">
    ...
    <%--custom alerts end--%>
    <script type="text/javascript" src="../Js/tstruct.min.js?v=631"></script>
    ...
    <script src="../Js/common.min.js?v=149" type="text/javascript"></script>
</head>
    ...
    <form id="f1" runat="server" dir="<%=direction%>">
        <div>
            <asp:ScriptManager ID="ScriptManager1" runat="server">
                <Scripts>
                    <asp:ScriptReference Path="../Js/tstruct.min.js?v=631" />
                </Scripts>
                <Services>
