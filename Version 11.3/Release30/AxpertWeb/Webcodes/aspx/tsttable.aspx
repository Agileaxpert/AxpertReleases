...
<head runat="server">
    ...
    <script src="../Js/common.min.js?v=149"></script>
    <script src="../Js/tstructvars.min.js?v=89"></script>
    <script src="../Js/tstruct.min.js?v=631"></script>
    <script src="../Js/tstTable.min.js?v=28"></script>
</head>
<body dir="<%=direction%>">
