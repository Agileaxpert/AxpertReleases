<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Complaint.aspx.cs" Inherits="aspx_Complaint" EnableViewState="false" %>
...
<body dir="<%=direction %>" class="btextDir-<%=direction%>">
    ...
    <script type="text/javascript" src="../Js/common.min.js?v=149"></script>
