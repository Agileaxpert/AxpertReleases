                                                        ...
                                                        <div class="menu-item px-3 my-0" id="viewMenuItem" data-kt-menu-trigger="hover" data-kt-menu-placement="right-end">
                                                            ...
                                                            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                                                <div class="menu-item px-3">
                                                                    <a href="#" class="menu-link px-3" id="tableView" onclick="onToggleButtonClick(); return false;" >
                                                                        <span class="material-icons material-icons-style">view_list</span> Table
                                                                    </a>
                                                                </div>
                                                                <div class="menu-item px-3">
                                                                    <a href="#" class="menu-link px-3" id="listView" onclick="onToggleButtonClick(); return false;" >
...
<div class="modal fade" id="confirmationModal" tabindex="-1" aria-labelledby="confirmationModalLabel" aria-hidden="true">
    ...
    <script src="../js/entity-filter.min.js?v=4"></script>
    <script src="../js/Entity-Common.min.js?v=2"></script>
    <script src="../js/entity.min.js?v=5"></script>
