...
public class TStructData
{
    ...
    private void SaveEmailSettings(XmlDocument inputXml)
    {
        try
        {
            string _smtphost = string.Empty, _smtpport = string.Empty, _smtpuser = string.Empty, _smtppwd = string.Empty;
            ...
            try
            {
                ...
                var propertiesDict = new Dictionary<string, object>
                 {
                { "host", smtphost.InnerText },
                { "port", smtpport.InnerText },
                { "user", smtpuser.InnerText },
                { "pwd", smtppwd.InnerText },
                { "arm_url", URL }
                 };
