    ...
    public class WebService : System.Web.Services.WebService
    {
        ...
        public string LoginOTPPushToQueue(string _proj, string _uname, string _loginRes, string otpAuthExpiry, string axOTPAuthCahrs, string _isotpNumeric, string _JsonSmtp)
        {
            ...
            try
            {
                ...
                string _subject = "Axpert OTP Authentication";
                string _emailBody = "Dear " + _uname + ",<br>One Time Password(OTP) for Axpert login is " + _otp + " <br>Regards,<br>Support Team.";
                string _smsMesg = "Dear " + _uname + ",\\nOne Time Password(OTP) for Axpert login is " + _otp + "";
                int _otpAuthExpiry = int.Parse(otpAuthExpiry) * 60;
                DATA = "{\"email\":{\"to\":[\"" + _emailid + "\"],\"subject\": \"" + _subject + "\",\"body\":[\"" + _emailBody + "\"]},\"sms\":{\"mobileno\":[\"" + _mobileNo + "\"],\"message\": [\"" + _smsMesg + "\"],\"otp\": \"" + _otp + "\"},\"redis\":{\"redisserver\":\"" + redisIp + "\",\"redisport\":\"" + redisPort + "\",\"redispwd\":\"" + redisPwd + "\",\"emailconfigkey\":\"" + _esredisKey + "\"}}";
