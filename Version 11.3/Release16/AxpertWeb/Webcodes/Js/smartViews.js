                    ...
                    case "t":
                        {
                            ...
                            var fullNavigationData = baseLink + "" + hLinkData + _params + _hLinkType + _torecid + navigationData + dynNavTst + _tstreadonly + `&isDupTab=${callParentNew('isDuplicateTab')}`;
                            if (isPopup) {
                                {
                                    listViewCbCellDataProp();
                                }
                            ...
                            if (ivHeadRows[colID]["@hltype"] == "load") {
                                ...
                                if (_params != "") {
                                    var fullNavigationDataNew = baseLink + "" + hLinkData + "&istsivparamcache=true" + _hLinkType + _torecid + navigationData + dynNavTst + _tstreadonly + `&isDupTab=${callParentNew('isDuplicateTab')}`;
                                    if (_urlProp == "" && isPopup)
                                        _urlProp = "popup";
