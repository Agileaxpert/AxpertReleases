...
public class Constants
{
    ...
    public static string[] fileTypes = { ".bmp", ".jpg", ".jpeg", ".pjpeg", ".png", ".gif", ".doc", ".docx", ".xml", ".xlsx", ".ppt", ".pdf", ".txt", ".xls", ".pwd", ".tiff", ".tif", ".dib", ".jfif", ".heic", ".xlxs", ".csv", ".eml", ".msg" ,".pptx"};
    ...
    public const string GET_SEARCH_DATA_OLDAPPURL = "select SEARCHTEXT,HLTYPE,STRUCTNAME,PARAMS,OLDAPPURL from axp_appsearch where username=:username and oldappurl is not null and lower(searchtext) like $KEYWORD$";
