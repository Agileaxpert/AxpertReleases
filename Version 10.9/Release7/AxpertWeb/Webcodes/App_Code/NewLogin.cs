...
public class LoginHelper
{
    ...
    public string oldappurl { get; set; }
    public string oaulandingpage { get; set; }
    ...
    private void GetLoginXml()
    {
        ...
        if (isSSO)
        {
            ...
            loginXml = "<login " + lang_at + " singleloginkey=\"" + privateSsoToken + "\" ssoname=\"" + SsoName + "\" " + lic_redis + " clouddb ='" + AxCloudDb + "' ip='" + ipaddress + "' other='" + userDetails + "'  seed='" + rnd_key + "'  axpapp='" + proj + "' sessionid='" + sid + "' username='" + user + "' password='' url='' direct='t' trace='" + errlog + "' " + lang_attr + licDetails + ">" + axApps + axProps + "</login>";
        }
        else
        {
            loginXml = "<login " + lang_at + " clouddb='" + AxCloudDb + "' " + lic_redis + " ip='" + ipaddress + "' other='" + userDetails + "'  seed='" + rnd_key + "'  axpapp='" + proj + "' sessionid='" + sid + "' username='" + user + "' password='" + HashedPassword + "' url='' direct='t' trace='" + errlog + "' " + lang_attr + licDetails + ">" + axApps + axProps + "</login>";
        }
    }
