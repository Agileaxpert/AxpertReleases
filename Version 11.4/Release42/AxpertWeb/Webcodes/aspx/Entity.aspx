...
<body id="Entitymanagement_Body" class="btextDir-<%=direction%> header-fixed header-tablet-and-mobile-fixed aside-fixed lightTheme" dir="<%=direction%>">
    <form id="form1" runat="server" enctype="multipart/form-data">
        ...
        <asp:HiddenField ID="hdnPageVars" runat="server" />
    </form>
    ...
    <script type="text/javascript" src="../Js/common.min.js?v=160"></script>
    ...
    <script src="../js/Entity-common.min.js?v=16"></script>
    <script src="../js/Entity.min.js?v=31"></script>
