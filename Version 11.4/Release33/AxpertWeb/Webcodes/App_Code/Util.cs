...
namespace Util
{
    ...
    public class Util
    {
        ...
        public void GetAxARMExternalResources(string strProj)
        {
            string jsoncontents = string.Empty;
            if (strProj != string.Empty)
            {
                try
                {
                    ...
                    if (jsoncontents == string.Empty)
                    {
                        ...
                        if (fi.Exists)
                        {
                            ...
                            if (jsonARM["appsettings"] != null && jsonARM["appsettings"][strProj] != null && jsonARM["appsettings"][strProj]["ExternalResources"] != null)
                            {
                                ...
                                {
                                    LogFile.Log logobj = new LogFile.Log();
                                    logobj.CreateLog("Exception in GetAxARMExternalResources while reading from file - util.cs- jsoncontents:" + jsoncontents + " Exception:" + ex.Message, HttpContext.Current.Session["nsessionid"].ToString(), "GetAxARMExternalResources-ex", "new");
                                }
                    ...
                    else if (jsoncontents != "noarmconnection")
                    {
                        ...
                        {
                            LogFile.Log logobj = new LogFile.Log();
                            logobj.CreateLog("Exception in GetAxARMExternalResources while reading from cache - util.cs- jsoncontents:" + jsoncontents + " Exception:" + ex.Message, HttpContext.Current.Session["nsessionid"].ToString(), "GetAxARMExternalResources-Exception", "new");
                        }
                    }
                }
                catch (Exception ex)
