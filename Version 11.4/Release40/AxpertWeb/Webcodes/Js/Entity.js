...
class RowsCountHelper {
    ...
    init() {
        ...
        if (!this.totalFetched && (_entity.listJson.length < ((_entity.pageSize * _entity.maxPageNumber) - 1)))
            this.totalRecords = _entity.listJson.length;

        var allDataLoaded = typeof this.totalRecords != "undefined" && this.totalRecords > 0;
        ...
        if (allDataLoaded) {
            this.rowCountElement.textContent = `Rows: 1-${_entity.listJson.length} of ${this.totalRecords}`;
            this.showQuestionMark(false);
        }
        else {
            this.rowCountElement.textContent = `Rows: 1-${(_entity.pageSize * _entity.maxPageNumber)} of`;

            // Add icon element
            this.iconElement = document.createElement('span');
            this.iconElement.id = 'global-rowcount-icon';
            this.iconElement.className = 'material-icons material-icons-style material-icons-3';
            this.iconElement.style.cssText = 'cursor: pointer; font-weight: 600; color: #666; display: inline-block; vertical-align: middle; font-size: 16px;';
            this.iconElement.textContent = 'question_mark';
            this.iconElement.title = 'Click to view total records';
        ...
        if (this.iconElement) this.containerElement.appendChild(this.iconElement);
    ...
    showQuestionMark(show) {
        if (this.iconElement) {
            if (show) {
                ...
                this.iconElement.style.cssText = `display: none;`;
            }
        }
    }
    ...
    handleIconClick() {
        ...
        this.iconElement.style.cursor = 'wait';
