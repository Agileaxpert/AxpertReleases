...
<head runat="server">
    ...
    <link rel="stylesheet" href="../css/Entity.min.css?v=6" />
    <style>
        </style>

</head>

<body id="Entitymanagement_Body" class="header-fixed header-tablet-and-mobile-fixed aside-fixed lightTheme"
    runat="server">
    ...
    <script type="text/javascript" src="../Js/common.min.js?v=150"></script>
    ...
    <script src="../js/Entity-filter.min.js?v=6"></script>
    <script src="../js/Entity-common.min.js?v=8"></script>
    <script src="../js/Entity.min.js?v=11"></script>
